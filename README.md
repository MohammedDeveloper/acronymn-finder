# Easily find all the acronyms in documents
- Collect words from the document (end to end)
- Find <[A-Z]{2,}>. (i.e., letters matching A to Z[capitalized] having minimum 2 letters)
- Use “ “ while reading words from the document
